...
def test_egcd():
  ...
  """
  gcd1, s, t = EGCD().egcd(99999999999999999999999999999999999999999999999, 12345678900987654321123451234567890098765432112344)
  # Corrected validation:
  gcd2 = s * 99999999999999999999999999999999999999999999999 + t * 12345678900987654321123451234567890098765432112344
  print(gcd1, s, t)
  print(gcd2)
